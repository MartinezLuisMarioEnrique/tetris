...
namespace Tetris {
	...
	/// </summary>
	public ref class PantallaDeJuego : public System::Windows::Forms::Form
	{
	public:
		PantallaDeJuego(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// panel108
			// 
			this->panel108->BorderStyle = System::Windows::Forms::BorderStyle::Fixed3D;
			this->panel108->Controls->Add(this->label7);
			this->panel108->Controls->Add(this->label6);
			this->panel108->Controls->Add(this->label5);
			this->panel108->Controls->Add(this->label4);
			...
			// label7
			// 
			this->label7->Font = (gcnew System::Drawing::Font(L"Snap ITC", 12.75F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point, 
				static_cast<System::Byte>(0)));
			this->label7->ForeColor = System::Drawing::Color::White;
			this->label7->Location = System::Drawing::Point(3, 443);
			this->label7->Name = L"label7";
			this->label7->Size = System::Drawing::Size(182, 62);
			this->label7->TabIndex = 7;
			this->label7->Text = L"Ingrid Paola López Niño";
			this->label7->TextAlign = System::Drawing::ContentAlignment::MiddleCenter;
			// 
			// label6
			// 
			this->label6->Font = (gcnew System::Drawing::Font(L"Snap ITC", 12.75F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point, 
				static_cast<System::Byte>(0)));
			this->label6->ForeColor = System::Drawing::Color::White;
			this->label6->Location = System::Drawing::Point(3, 410);
			this->label6->Name = L"label6";
			this->label6->Size = System::Drawing::Size(182, 23);
			this->label6->TabIndex = 6;
			this->label6->Text = L"elaborado por";
			this->label6->TextAlign = System::Drawing::ContentAlignment::MiddleCenter;
			// 
			// label5
			// 
			this->label5->Font = (gcnew System::Drawing::Font(L"Snap ITC", 12.75F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point, 
				static_cast<System::Byte>(0)));
			...
			// label4
			// 
			this->label4->Font = (gcnew System::Drawing::Font(L"Snap ITC", 12.75F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point, 
				static_cast<System::Byte>(0)));
			this->label4->ForeColor = System::Drawing::Color::Yellow;
			this->label4->Location = System::Drawing::Point(3, 100);
			this->label4->Name = L"label4";
			this->label4->Size = System::Drawing::Size(182, 23);
			...
			// label3
			// 
			this->label3->Font = (gcnew System::Drawing::Font(L"Snap ITC", 12.75F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point, 
				static_cast<System::Byte>(0)));
			...
			// label2
			// 
			this->label2->Font = (gcnew System::Drawing::Font(L"Snap ITC", 12.75F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point, 
				static_cast<System::Byte>(0)));
			...
			this->label2->Text = L"puntuación";
			this->label2->TextAlign = System::Drawing::ContentAlignment::MiddleCenter;
			// 
			// label1
			// 
			this->label1->Font = (gcnew System::Drawing::Font(L"Snap ITC", 12.75F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point, 
				static_cast<System::Byte>(0)));
			this->label1->ForeColor = System::Drawing::Color::Yellow;
			this->label1->Location = System::Drawing::Point(3, 199);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(182, 23);
			this->label1->TabIndex = 0;
			this->label1->Text = L"próxima figura";
